...
namespace Forum.Controllers
{
    public class ThreadsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,CreatedDate")] Thread thread)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,CreatedDate")] Thread thread)
        {
            if (id != thread.Id)
            {
                return NotFound();
